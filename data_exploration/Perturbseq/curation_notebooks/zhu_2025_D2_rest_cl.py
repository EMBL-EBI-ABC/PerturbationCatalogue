...
log("=== zhu_2025_D2_rest_cl curation started ===")
...
noncurated_path = '/hps/nobackup/mfreeberg/marson_downloads/zhu_2025_D2_rest_cl.h5ad'
...
cur_data.adata.obs['cell_barcode'] = cur_data.adata.obs.index.str.split('_').str[0] + '_' + 'D2-REST'
...
cur_data.create_columns(
    ...
    col_dict={
        ...
        "experiment_title": "Perturb-seq of primary human CD4-positive T cells for patient D2_CE0010866 under resting conditions",
        "experiment_summary": """
        ...
        "associated_datasets": json.dumps([
            {
                ...
                "dataset_uri": "s3://genome-scale-tcell-perturb-seq/marson2025_data/D2_Rest.assigned_guide.h5ad",
                "dataset_description": "Cell expression profiles for cells from donor D2_CE0010866, stimulated for 8hr with ImmunoCult CD3/CD28/CD2 activator.",
                "dataset_file_name": "D2_Rest.assigned_guide.h5ad",
            }
        ])
    }
)
...
upload_parquet_to_bq(
    parquet_path='/hps/nobackup/mfreeberg/marson_downloads/zhu_2025_D2_rest_cl_curated_metadata.parquet',
...
# !gcloud storage cp /hps/nobackup/mfreeberg/marson_downloads/zhu_2025_D2_rest_cl_curated.h5ad gs://perturbation-catalogue-lake/perturbseq/curated/
