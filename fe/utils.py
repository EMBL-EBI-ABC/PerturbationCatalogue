...
BACKEND_URL = os.getenv("BACKEND_URL", "https://new-pc-be-v3-959149465821.europe-west2.run.app")
...
def create_card_content(result: Dict[str, Any]) -> List:
    ...
    content.append(
        ...
        ], className="mb-3 w-100", style={"fontSize": "16px"})
    )

    # Group 1: RNA-seq related stats
    rnaseq_stats = []
    rnaseq_fields = ["n_sig_perturb_pairs_up", "n_sig_perturb_pairs_down", "lfc_q25", "lfc_median", "lfc_q75"]
    ...
    if rnaseq_stats or sig_pairs_up or sig_pairs_down:
        ...
        rnaseq_section.append(
            html.Div([
                html.H6("RNA-seq Statistics", style={"color": COLORS["secondary"], "marginBottom": "10px", "fontWeight": "600"}),
                html.Div(rnaseq_stats)
            ], className="mb-3 stats-box", style={"padding": "16px"})
        )
        ...
        if sig_pairs_up or sig_pairs_down:
            ...
            up_table_rows.append(
                html.Tr([
                    html.Th("Gene", style={"padding": "8px", "border": "1px solid #ddd", "backgroundColor": COLORS["primary"], "color": "white"}),
                    html.Th("p-adj", style={"padding": "8px", "border": "1px solid #ddd", "backgroundColor": COLORS["primary"], "color": "white"}),
                    html.Th("log2FoldChange", style={"padding": "8px", "border": "1px solid #ddd", "backgroundColor": COLORS["primary"], "color": "white"}),
                    html.Th(html.I(className="bi bi-arrow-up"), style={"padding": "8px", "border": "1px solid #ddd", "backgroundColor": COLORS["primary"], "color": "white", "textAlign": "center"})
                ])
            )
            ...
            for pair in sig_pairs_up[:10]:  # Limit to 10 for display
                ...
                up_table_rows.append(
                    html.Tr([
                        html.Td(parsed["gene"], style={"padding": "8px", "border": "1px solid #ddd"}),
                        html.Td(format_number(parsed["padj"]), style={"padding": "8px", "border": "1px solid #ddd"}),
                        html.Td(format_number(parsed["log2foldchange"]), style={"padding": "8px", "border": "1px solid #ddd"}),
                        html.Td([
                            html.I(className="bi bi-arrow-up", style={"color": COLORS["primary"], "fontSize": "18px", "fontWeight": "bold"})
            ...
            if len(sig_pairs_up) > 10:
                up_table_rows.append(
                    html.Tr([
                        html.Td(f"... ({len(sig_pairs_up) - 10} more)",
                               colSpan=4, style={"padding": "8px", "border": "1px solid #ddd", "textAlign": "center", "fontStyle": "italic"})
                    ])
                )
            ...
            down_table_rows.append(
                html.Tr([
                    html.Th("Gene", style={"padding": "8px", "border": "1px solid #ddd", "backgroundColor": COLORS["red"], "color": "white"}),
                    html.Th("p-adj", style={"padding": "8px", "border": "1px solid #ddd", "backgroundColor": COLORS["red"], "color": "white"}),
                    html.Th("log2FoldChange", style={"padding": "8px", "border": "1px solid #ddd", "backgroundColor": COLORS["red"], "color": "white"}),
                    html.Th(html.I(className="bi bi-arrow-down"), style={"padding": "8px", "border": "1px solid #ddd", "backgroundColor": COLORS["red"], "color": "white", "textAlign": "center"})
                ])
            )
            ...
            for pair in sig_pairs_down[:10]:  # Limit to 10 for display
                ...
                down_table_rows.append(
                    html.Tr([
                        ...
                        html.Td(format_number(parsed["log2foldchange"]), style={"padding": "8px", "border": "1px solid #ddd"}),
                        html.Td([
                            html.I(className="bi bi-arrow-down", style={"color": COLORS["red"], "fontSize": "18px", "fontWeight": "bold"})
                        ], style={"padding": "8px", "border": "1px solid #ddd", "textAlign": "center"})
                    ])
                )
            ...
            if len(sig_pairs_down) > 10:
                down_table_rows.append(
                    html.Tr([
                        html.Td(f"... ({len(sig_pairs_down) - 10} more)",
                               colSpan=4, style={"padding": "8px", "border": "1px solid #ddd", "textAlign": "center", "fontStyle": "italic"})
                    ])
                )
            ...
            rnaseq_section.append(
                html.Div([
                    html.H6("Significant Gene Pairs", style={"color": COLORS["gray"], "marginBottom": "10px"}),
                    html.Div([
                        html.H6("Up", style={"color": COLORS["primary"], "fontSize": "14px", "marginBottom": "5px"}),
                        html.Table([
                            html.Thead(up_table_rows[0]),
                            html.Tbody(up_table_rows[1:])
                        ], style={"width": "100%", "borderCollapse": "collapse", "fontSize": "11px"}, className="table-responsive mb-3")
                    ], className="d-md-none"),  # Stacked version for mobile
                    dbc.Row([
                        dbc.Col([
                            html.Div([
                                html.H6("Up", style={"color": COLORS["primary"], "fontSize": "14px", "marginBottom": "5px", "display": "none"}, className="d-md-block"),
                                html.Table([
                                    html.Thead(up_table_rows[0]),
                                    html.Tbody(up_table_rows[1:])
                                ], style={"width": "100%", "borderCollapse": "collapse", "fontSize": "11px"}, className="table-responsive")
                            ])
                        ], width={"size": 6, "md": 6, "sm": 12}, className="mb-3 mb-md-0"),
                        dbc.Col([
                            html.Div([
                                html.H6("Down", style={"color": COLORS["red"], "fontSize": "14px", "marginBottom": "5px", "display": "none"}, className="d-md-block"),
                                html.Table([
                    ...
                    ], className="d-none d-md-flex"),  # Side by side for desktop
                    html.Div([
                        html.H6("Down", style={"color": COLORS["red"], "fontSize": "14px", "marginBottom": "5px"}),
                        html.Table([
                            html.Thead(down_table_rows[0]),
                            html.Tbody(down_table_rows[1:])
                        ], style={"width": "100%", "borderCollapse": "collapse", "fontSize": "11px"}, className="table-responsive mb-3")
    ...
    crispr_stats.append(
        html.Div([
            html.Strong("N Sig Crispr: "),
            html.Span(format_value(n_sig_crispr))
        ], className="mb-1")
    )
    ...
    if crispr_stats:
        content.append(
            html.Div([
                html.H6("CRISPR Screen Statistics", style={"color": COLORS["accent1"], "marginBottom": "10px", "fontWeight": "600"}),
    ...
    if "n_mave" in result or mave_scores_up or mave_scores_down:
        ...
        mave_section.append(
            html.Div([
                html.H6("MAVE Statistics", style={"color": COLORS["accent2"], "marginBottom": "10px", "fontWeight": "600"}),
                html.Div([
                    html.Strong("N Mave: "),
        ...
        if mave_scores_up or mave_scores_down:
            ...
            up_table_rows.append(
                html.Tr([
                    html.Th("Variant", style={"padding": "8px", "border": "1px solid #ddd", "backgroundColor": COLORS["primary"], "color": "white"}),
                    html.Th("Score", style={"padding": "8px", "border": "1px solid #ddd", "backgroundColor": COLORS["primary"], "color": "white"}),
                    html.Th(html.I(className="bi bi-arrow-up"), style={"padding": "8px", "border": "1px solid #ddd", "backgroundColor": COLORS["primary"], "color": "white", "textAlign": "center"})
                ])
            )
            ...
            for score in mave_scores_up[:10]:  # Limit to 10 for display
                ...
                up_table_rows.append(
                    html.Tr([
                        html.Td(parsed["variant"], style={"padding": "8px", "border": "1px solid #ddd"}),
                        html.Td(format_score(parsed["score"]), style={"padding": "8px", "border": "1px solid #ddd"}),
                        html.Td([
                            html.I(className="bi bi-arrow-up", style={"color": COLORS["primary"], "fontSize": "18px", "fontWeight": "bold"})
                        ], style={"padding": "8px", "border": "1px solid #ddd", "textAlign": "center"})
                    ])
            ...
            if len(mave_scores_up) > 10:
                up_table_rows.append(
                    html.Tr([
                        html.Td(f"... ({len(mave_scores_up) - 10} more)",
                               colSpan=3, style={"padding": "8px", "border": "1px solid #ddd", "textAlign": "center", "fontStyle": "italic"})
                    ])
                )
            ...
            down_table_rows.append(
                html.Tr([
                    html.Th("Variant", style={"padding": "8px", "border": "1px solid #ddd", "backgroundColor": COLORS["red"], "color": "white"}),
                    html.Th("Score", style={"padding": "8px", "border": "1px solid #ddd", "backgroundColor": COLORS["red"], "color": "white"}),
                    html.Th(html.I(className="bi bi-arrow-down"), style={"padding": "8px", "border": "1px solid #ddd", "backgroundColor": COLORS["red"], "color": "white", "textAlign": "center"})
                ])
            )
            ...
            if len(mave_scores_down) > 10:
                down_table_rows.append(
                    html.Tr([
                        html.Td(f"... ({len(mave_scores_down) - 10} more)",
                               colSpan=3, style={"padding": "8px", "border": "1px solid #ddd", "textAlign": "center", "fontStyle": "italic"})
                    ])
                )
            ...
            mave_section.append(
                html.Div([
                    html.H6("MAVE Scores", style={"color": COLORS["gray"], "marginBottom": "10px"}),
                    html.Div([
                        html.H6("Up", style={"color": COLORS["primary"], "fontSize": "14px", "marginBottom": "5px"}),
                        html.Table([
                            html.Thead(up_table_rows[0]),
...
def create_stats_display(result: Dict[str, Any]) -> List:
    ...
    if crispr_stats:
        content.append(
            html.Div([
                html.H6("CRISPR Screen Statistics", style={"color": COLORS["accent1"], "marginBottom": "10px"}),
                html.Div(crispr_stats)
            ], className="mb-3", style={"padding": "10px", "backgroundColor": "#f8f9fa", "borderRadius": "5px"})
        )
...
def create_filter_component(facet_name: str, facet_values: List[Dict[str, Any]], selected: List[str]) -> html.Div:
    ...
    sorted_values = sorted(facet_values, key=lambda x: x.get('count', 0), reverse=True)[:5]
    ...
    return html.Div([
        html.Label(display_name, style={"fontWeight": "bold", "marginTop": "10px", "marginBottom": "5px"}),
        dcc.Checklist(
    ...
    ], style={"marginBottom": "20px"}, className="col-12")  # Full width on mobile, one per row

# Helper function to create chart component (pie or bar chart)
def create_chart_component(facet_name: str, facet_values: List[Dict[str, Any]], selected: List[str]) -> html.Div:
    ...
    if not facet_values:
        return html.Div([
            html.H6(display_name, style={"fontWeight": "600", "marginBottom": "5px", "color": COLORS["primary"], "fontSize": "0.9rem"}),
            html.P("No data available", style={"color": "#999", "fontSize": "0.8rem"})
    ...
    if use_pie:
        ...
        bar_colors = [category_color if label in selected else category_color_light for label in labels]
        ...
        all_options = [{"label": f"{item['value']} ({item['count']})", "value": item['value']} for item in sorted_values]
        ...
        if rest_values:
            return html.Div([
                chart,
                html.P(f"Showing top 5. Select from all {len(sorted_values)} values:",
                       style={"fontSize": "0.75rem", "color": "#666", "marginTop": "5px", "marginBottom": "3px"}),
                dropdown
            ], style={"width": "100%", "marginBottom": "0.5rem"})
        else:
            return html.Div([
