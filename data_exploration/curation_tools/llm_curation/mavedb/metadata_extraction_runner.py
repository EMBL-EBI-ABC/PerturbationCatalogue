...
METADATA_EXTRACTION_LOG_FILE = MAVEDB_LLM_METADATA_DIR / "mavedb_metadata_extraction.log"
PUBLICATION_FULL_TEXT_MD_DIR = SCRIPT_DIR / "pub_full_text_md"
DEFAULT_BULK_EXCLUDED_PUBLICATION_FILES = frozenset(
...
def main() -> None:
    ...
    bulk_extract_metadata_from_publications(
        ...
        log_file=METADATA_EXTRACTION_LOG_FILE,
