...
log("=== zhu_2025_D4_rest_cl curation started ===")
...
noncurated_path = '/hps/nobackup/mfreeberg/marson_downloads/zhu_2025_D4_rest_cl.h5ad'
...
cur_data.adata.obs['cell_barcode'] = cur_data.adata.obs.index.str.split('_').str[0] + '_' + 'D4-REST'
...
cur_data.create_columns(
    ...
    col_dict={
        ...
        "experiment_title": "Perturb-seq of primary human CD4-positive T cells for patient D4_CE0006864 under resting conditions",
        "experiment_summary": """
        ...
        "associated_datasets": json.dumps([
            {
                ...
                "dataset_uri": "s3://genome-scale-tcell-perturb-seq/marson2025_data/D4_Rest.assigned_guide.h5ad",
                ...
                "dataset_file_name": "D4_Rest.assigned_guide.h5ad",
            }
        ])
    }
)
...
upload_parquet_to_bq(
    parquet_path='/hps/nobackup/mfreeberg/marson_downloads/zhu_2025_D4_rest_cl_curated_metadata.parquet',
...
# !gcloud storage cp /hps/nobackup/mfreeberg/marson_downloads/zhu_2025_D4_rest_cl_curated.h5ad gs://perturbation-catalogue-lake/perturbseq/curated/
