...
REQUIRED_VARS=(
    ...
    GCLOUD_TMP_BUCKET
    PG_CONN_INTERNAL
    PG_CRISPR_DATA_TABLE
    PG_MAVE_DATA_TABLE
    PG_PERTURB_SEQ_DEA_TABLE
    PG_PERTURB_SEQ_GSEA_TABLE
    PG_SYNC_STATE_TABLE
    PG_PERTURB_SEQ_SUMMARY_PERTURBATION
    PG_PERTURB_SEQ_SUMMARY_EFFECT
    PG_PERTURB_SEQ_SUMMARY_DATASET
    ES_URL
    ES_USERNAME
    ES_PASSWORD
    ES_DATASET_SUMMARY
...
_PG_CRISPR_DATA_TABLE=$PG_CRISPR_DATA_TABLE,\
_PG_MAVE_DATA_TABLE=$PG_MAVE_DATA_TABLE,\
_PG_PERTURB_SEQ_DEA_TABLE=$PG_PERTURB_SEQ_DEA_TABLE,\
_PG_PERTURB_SEQ_GSEA_TABLE=$PG_PERTURB_SEQ_GSEA_TABLE,\
_PG_SYNC_STATE_TABLE=$PG_SYNC_STATE_TABLE,\
_PG_PERTURB_SEQ_SUMMARY_PERTURBATION=$PG_PERTURB_SEQ_SUMMARY_PERTURBATION,\
_PG_PERTURB_SEQ_SUMMARY_EFFECT=$PG_PERTURB_SEQ_SUMMARY_EFFECT,\
_PG_PERTURB_SEQ_SUMMARY_DATASET=$PG_PERTURB_SEQ_SUMMARY_DATASET,\
_ES_URL=$ES_URL,\
