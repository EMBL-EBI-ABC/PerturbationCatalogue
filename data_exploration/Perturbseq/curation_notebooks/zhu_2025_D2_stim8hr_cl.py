...
cur_data.create_columns(
    ...
    col_dict={
        ...
        "experiment_title": "Perturb-seq of primary human CD4-positive T cells for patient D2_CE0010866, stimulated for 8hr with ImmunoCult CD3/CD28/CD2 activator",
        "experiment_summary": """
        ...
        "associated_datasets": json.dumps([
            {
                ...
                "dataset_uri": "s3://genome-scale-tcell-perturb-seq/marson2025_data/D2_Stim8hr.assigned_guide.h5ad",
                ...
                "dataset_file_name": "D2_Stim8hr.assigned_guide.h5ad",
            }
        ])
    }
)
