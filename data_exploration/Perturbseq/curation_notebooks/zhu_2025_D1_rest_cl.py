...
log("=== zhu_2025_D1_rest_cl curation started ===")
...
noncurated_path = '/hps/nobackup/mfreeberg/marson_downloads/zhu_2025_D1_rest_cl.h5ad'
...
cur_data.adata.obs['cell_barcode'] = cur_data.adata.obs.index.str.split('_').str[0] + '_' + 'D1-REST'
        ...
        "associated_datasets": json.dumps([
            {
                ...
                "dataset_file_name": "D1_Rest.assigned_guide.h5ad",
            }
        ])
    }
)
...
upload_parquet_to_bq(
    parquet_path='/hps/nobackup/mfreeberg/marson_downloads/zhu_2025_D1_rest_cl_curated_metadata.parquet',
...
# !gcloud storage cp /hps/nobackup/mfreeberg/marson_downloads/zhu_2025_D1_rest_cl_curated.h5ad gs://perturbation-catalogue-lake/perturbseq/curated/
