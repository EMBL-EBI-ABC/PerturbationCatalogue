...
log("=== zhu_2025_D1_stim48hr_cl curation started ===")
...
noncurated_path = '/hps/nobackup/mfreeberg/marson_downloads/zhu_2025_D1_stim48hr_cl.h5ad'
...
cur_data.adata.obs['cell_barcode'] = cur_data.adata.obs.index.str.split('_').str[0] + '_' + 'D1-STIM48HR'
...
cur_data.create_columns(
    ...
    col_dict={
        ...
        "experiment_title": "Perturb-seq of primary human CD4-positive T cells for patient D1_CE0008162, stimulated for 48hr with ImmunoCult CD3/CD28/CD2 activator",
        "experiment_summary": """
        ...
        "associated_datasets": json.dumps([
            {
                ...
                "dataset_uri": "s3://genome-scale-tcell-perturb-seq/marson2025_data/D1_Stim48hr.assigned_guide.h5ad",
                "dataset_description": "Cell expression profiles for cells from donor D1_CE0008162, stimulated for 48hr with ImmunoCult CD3/CD28/CD2 activator.",
                "dataset_file_name": "D1_Stim48hr.assigned_guide.h5ad",
            }
        ])
    }
)
...
upload_parquet_to_bq(
    parquet_path='/hps/nobackup/mfreeberg/marson_downloads/zhu_2025_D1_stim48hr_cl_curated_metadata.parquet',
...
# !gcloud storage cp /hps/nobackup/mfreeberg/marson_downloads/zhu_2025_D1_stim48hr_cl_curated.h5ad gs://perturbation-catalogue-lake/perturbseq/curated/
