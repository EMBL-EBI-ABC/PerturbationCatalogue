...
\begin{frame}{Questions \& Discussion}
    \begin{itemize}
        \item \textbf{Post-processing:} Any recommended additional filtering or normalization steps for unified H5AD files?
        \item \textbf{Caveats:} What are the most common pitfalls or "gotchas" when re-processing Perturb-Seq from FASTQ?
        \item \textbf{Improvements:} Any other suggestions for enhancing the pipeline or downstream interpretation?
    \end{itemize}
    \vspace{2em}
    \centering
    \textbf{Thank you for your feedback!}
\end{frame}
