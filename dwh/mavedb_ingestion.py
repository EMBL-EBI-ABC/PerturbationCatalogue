...
parser = argparse.ArgumentParser(description="Load MaveDB data from CSV into BigQuery")
parser.add_argument("--project", required=True, help="Specify Google Cloud project")
parser.add_argument("--bq_dataset_name", required=True, help="BigQuery dataset name")
parser.add_argument("--region", required=True, help="Specify Google Cloud region")
parser.add_argument(
    "--stagingLocation", required=True, help="Specify Cloud Storage bucket for staging"
)
parser.add_argument(
...
(
    p
    | "Read data from CSV file" >> beam.io.ReadFromText(data_input, skip_header_lines=1)
