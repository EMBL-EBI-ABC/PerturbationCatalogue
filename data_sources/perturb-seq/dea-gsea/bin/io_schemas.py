...
DEA_SCHEMA = pa.schema(
    [
        ...
        pa.field("perturbed_target_ensg", pa.string(), nullable=True),
        pa.field("effect_gene_symbol", pa.string(), nullable=True),
        pa.field("effect_gene_ensg", pa.string(), nullable=True),
