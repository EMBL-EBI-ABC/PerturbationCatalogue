...
* **API** → [https://www.ebi.ac.uk/perturbation-catalogue/v1/crispr-screen/search?perturbed_target=BRCA2](https://www.ebi.ac.uk/perturbation-catalogue/v1/crispr-screen/search?perturbed_target=BRCA2)
